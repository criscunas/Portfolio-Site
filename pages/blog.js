        ...
        <>
            ...
            <Box className={blogPage.blogs}>
                <div className={blogPage.blogs__header}>
                    <h1 className={blogPage.blogs__header_title}>
                        {" "}
                        Cris's Blog <span aria-labe="technologist">
                            {" "}
                            👨🏻‍💻
                        </span>{" "}
                    </h1>
                    <p className={blogPage.blogs__header_sub}>
                        {" "}
                        Updated weekly.{" "}
                    </p>
                </div>
                    ...
                    return (
                        <Card key={i} className={blogPage.blogs__card}>
                            <div className={blogPage.blogs__card_body}>
                                <h1 className={blogPage.blogs__card_title}>
                                    {" "}
                                    {post.title}{" "}
                                </h1>
                                ...
                                <p className={blogPage.blogs__card_excerpt}>
                                    {" "}
                                    {post.excerpt} ...{" "}
                                </p>
                            </div>
                            <div className={blogPage.blogs__card_footer}>
                                ...
                                >
                                    <p className={blogPage.blogs__button_text}>
                                        {" "}
                                        Read{" "}
                                    </p>
                                </Button>
